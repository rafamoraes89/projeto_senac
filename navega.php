...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js" integrity="sha384-QJHtvGhmr9XOIpI6YVutG+2QOK9T+ZnN4kzFN1RtK3zEFEIsxhlmWl5/YESvpZ13" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="estilo_navega.css">
  ...
  <div class="container">
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse nav-items" id="navbarNav">
                  <ul class="navbar-nav ms-md-auto">
                    <li class="nav-item">
                      <a class="nav-link active"href="cadastro_clientes.php" target="_blank">Cadastrar/Clientes</a></a
                      >
                    </li>
                    <li class="nav-item">
    ...
    <div class="row mt-5">
      <div class="col pt-5 text-center">
        <h1>Bem vindo à<br> Área Restrita</h1>

        <h3 class="mt-5">Você deseja:</h3>
        <div class="div-navega">
            <a class="btn-my" href="cadastro_clientes.php" target="_blank">Cadastrar/Clientes</a>
            <a class="btn-my" href="cadastro_produtos.php" target="_blank">Cadastrar/Produtos</a>
            <a class="btn-my" href="consulta_cliente.php" target="_blank">Consultar/Clientes</a>
            <a class="btn-my" href="consulta_produto.php" target="_blank">Consultar/Produtos</a>
